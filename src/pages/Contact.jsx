  ...
  return (
    <div
            ...
            <div className="p-8 bg-gray-900">
                <h2 className="text-3xl font-bold text-white">Get In <span className="text-yellow-400">Touch</span></h2>
                ...
                <ul className="mt-4 flex flex-wrap justify-center gap-4 lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
                    <li className="flex items-center text-yellow-400">
                        ...
                        <a href="mailto:info@alumni.com" className="text-current text-sm ml-3">
                            info@alumni.com
                        </a>
                    </li>
                    <li className="flex items-center text-yellow-400">
                        ...
                        <a href="tel:+251955350910" className="text-current text-sm ml-3">
                            +251955350910
                        </a>
                    </li>
                </ul>
