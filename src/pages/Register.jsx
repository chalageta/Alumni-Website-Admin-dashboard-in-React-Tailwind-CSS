    ...
    <div className="mx-4 mb-4 -mt-16">
      <form className="max-w-4xl mx-auto bg-white shadow-[0_2px_13px_-6px_rgba(0,0,0,0.4)] sm:p-8 p-4 rounded-md">
        ...
        <div>
          ...
          <div>
            <label className="text-gray-800 text-sm mb-2 block">Field of Study</label>
            <input name="lname" type="text" className="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-3 rounded-md outline-blue-500 transition-all" placeholder="Enter field of study" />
          </div>
          <div>
            <label className="text-gray-800 text-sm mb-2 block">Academic Status</label>
            <input name="lname" type="text" className="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-3 rounded-md outline-blue-500 transition-all" placeholder="Enter academic  status" />
          </div>
          <div>
            <label className="text-gray-800 text-sm mb-2 block">Years Served</label>
            <input name="lname" type="text" className="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-3 rounded-md outline-blue-500 transition-all" placeholder="Enter  year" />
          </div>
          <div>
            <label className="text-gray-800 text-sm mb-2 block">Position</label>
            <input name="lname" type="text" className="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-3 rounded-md outline-blue-500 transition-all" placeholder="Enter  Position" />
          </div>

        </div>
        <div className="mt-8">
          <button style={{backgroundColor:currentColor}} type="button" className="py-3 px-6 text-sm tracking-wider font-semibold rounded-md text-white  hover:bg-blue-600 focus:outline-none">
            Sign up
          </button>
        </div>
      </form>
